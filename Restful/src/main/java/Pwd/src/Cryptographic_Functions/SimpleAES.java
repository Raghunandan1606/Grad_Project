...
public class SimpleAES {
	...
	public static void main(String[] args) {
		System.out.println(
				decrypt("U2FsdGVkX1/IKk81XvvCdVkGP5Xwg47UphXD1XIXbyitVhlwbd1PCTKtqty/4bWb", 
						Constants_PWD.secretKey));
	}
	...
	public static String decrypt(String cipherText, String secret) {
		try {
			...
			// String cipherText =
			// "U2FsdGVkX1+0PrUnm5B4rqOpQLbeuZgIvQ+PbU2/o9B1LoJkclzw1Clxm2LuLptc";
